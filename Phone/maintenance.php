            ...
            <div class="navigation-up">
                <div class="navigation-inner">
                    <div class="navigation-v3">
                        <ul>
                            <li _t_nav="categories"><h2><a href="javascript:void(0);">Categories</a></h2></li>
                            <li _t_nav="sort"><h2><a href="javascript:void(0);">Sort</a></h2></li>
                            <li _t_nav="selected"><h2><a href="maintenance.php?Sort=Selected">Sort By Selected</a></h2></li>
                ...
                <div class="product-intro" onmouseover="show_border('<?php echo $one_serviceitem['Item_Id']?>')" onmouseout="show_out('<?php echo $one_serviceitem['Item_Id']?>')" >
				    <div class='product-intro-content' >
                        <div class="product-theme">
                            ...
                            <?php
                                for($i=0;$i<(int)$one_serviceitem['Rating'];$i++) {
                            ?>
                                    <img src="images/article/lan.png" style="position:relative;top:2px;left:5px;" width="16px">
                            <?php
                                }
                            ?>
				        </div>
				        <div class="product-main">
                            ...
                            <div class="product-detail">
                                ...
                                <a class="check" id="<?php echo $one_serviceitem['Item_Id']?>" href="maintenance_Detail.php?Item_Id=<?php echo $one_serviceitem['Item_Id']?>" target="_blank">Check</a>
                            </div>
                            <div class='pd_split' ></div>
                            <div class='reset' ></div>
                            <div class="product-situ">
                                <span><label class="spe-label" ><?php echo $one_serviceitem['Selected_Quantities']; ?></label> selected</span>
                                <span><label class="spe-label" ><?php echo $one_serviceitem['Page_View']; ?></label> viewed</span>
                            </div>
                            <div class='reset' ></div>
                        </div>
                    </div>
...
$(window).resize(function(){
    if(document.body.clientWidth>768){
        window.location.href="../PC_Tablet/maintenance.php";
    }
});
</script>