<?php
    function doSaveData($Customer_Name, $Username, $target, $Password, $Gender, $Phone, $Address, $Email, $License_No) {
        ...
        if($count != 0) {
            $sql = "INSERT INTO customer (Customer_Name, Username, Customer_Picture, Password, Gender, Phone, Address, Email, License_No, Location_Id, Last_Region_Id, Last_Login_Time, Updated, Created) VALUES ('$Customer_Name', '$Username', '$target', '$Password', '$Gender', '$Phone', '$Address','$Email', '$License_No', 1, 1, '$timestamp', '$timestamp', '$timestamp')";
