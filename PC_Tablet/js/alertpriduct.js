    $(document).ready(function()
    {
		...
		$('#baoyangdaohangt').click(function()
		{
            ...
            $('#baoyangfuwut').css('color','white');
            $('#baoyangdaohangt').css('color','black');
            $('#weixiufuwut').css('color','white');
		});
		$('#baoyangfuwut').click(function()
		{
			...
			$('.wxz').css('background','#4eb233');
			$('.yxz').css('background','#fff');
            $('#baoyangfuwut').css('color','black');
            $('#baoyangdaohangt').css('color','white');
            $('#weixiufuwut').css('color','white');
		});
